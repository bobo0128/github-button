...
class GithubButtonNewtab extends LitElement {
  static get styles() {
    return css`
      * {
        margin: 0;
  ...
  render() {
    return html`
      <button
        id="btn"
        title="github link new tab"
        aria-label="github link new tab"
...
customElements.define("github-button-newtab", GithubButtonNewtab);
