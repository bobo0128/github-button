...
class GithubButtonOption extends LitElement {
  static get styles() {
    return css`
      * {
        margin: 0;
  ...
  render() {
    return html`
      <button
        id="btn"
        title="github link option"
        aria-label="github link option"
...
customElements.define("github-button-option", GithubButtonOption);
